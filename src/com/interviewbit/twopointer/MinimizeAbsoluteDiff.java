...
public class MinimizeAbsoluteDiff {
	...
	public int solve(ArrayList<Integer> A, ArrayList<Integer> B, ArrayList<Integer> C) {
		...
		int max = Math.max(A.get(iComb), Math.max(B.get(jComb), C.get(kComb)));
		int min = Math.min(A.get(iComb), Math.min(B.get(jComb), C.get(kComb)));
	...
	public void test() {
		...
		Assert.assertEquals(1, solve(a, b, c));
	...
	public void test1() {
		...
		Assert.assertEquals(0, solve(a, b, c));
